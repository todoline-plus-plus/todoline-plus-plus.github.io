...
jQuery(document).ready(function ($) {
  ...
  /**
	 * load todoline++ custom js 
	 *
	 * @method   Load_TodoLine_Methods
	 */
  const Load_TodoLine_Methods = function () {
    // console.log("load todoline method");
		$("body").append('<script src="/plugin/todoline/todoline.js"></script>');
	};
